        ...
        <div className="ml-5">
          ...
          <div className="flex justify-evenly">
              ...
              <div className="flex justify-around">
                <div class="flex items-center justify-center w-[50%]">
                  <div className="text-center">
                    <p className="text-white font-bold text-4xl mb-2">{data.Livret[0].type}</p>
                    <p className="text-white font-bold text-4xl mb-4">{data.Livret[0].soldeLivret} €</p>
                    <p className="text-white font-bold text-4xl mb-2">Previsionelle</p>
                    <div className="flex justify-between mb-4">
                      <p className="text-white font-bold text-4xl">{data.Livret[0].type === "A" ? (2 / 100) * data.Livret[0].soldeLivret : (3 / 100) * data.Livret[0].soldeLivret} €</p>
                      <p className="text-white font-bold text-4xl">{data.Livret[0].type === "A" ? "2%" : "3%"}
                      </p>
                    </div>
                  </div>
                </div>
                {numberLivret > 1 && (
                  <>
                    ...
                    <div class="flex items-center justify-center w-[50%]">
                      <div className="text-center">
                        <p className="text-white font-bold text-4xl mb-2">{data.Livret[1].type}</p>
                        <p className="text-white font-bold text-4xl mb-4">XXXX€</p>
                        <p className="text-white font-bold text-4xl mb-2">Previsionelle</p>
                        <div className="flex justify-between mb-4">
            ...
            <div class="w-[45%] mt-10 bg-black rounded-3xl shadow-md p-8">
              <h1 class="text-white font-bold text-4xl mb-12 justify-center flex">Transaction</h1>
              <div className="flex justify-around">
                <div class="flex items-center justify-center w-[50%]">
                  <div className="text-center">
                    <p className="text-white font-bold text-4xl mb-2">A venir</p>
